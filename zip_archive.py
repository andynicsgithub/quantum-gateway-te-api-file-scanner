...
class ZipArchiveManager:
    ...
    def consolidate(self, temp_dir, verdict_basenames, password):
        ...
        try:
            ...
            self.logger.info(
                f"Consolidated files from temp directory into {self.zip_path}"
            )
        except Exception as e:
    ...
    def close(self):
        ...
        try:
            ...
            self.logger.info(
                f"Zip archive closed: {self.zip_path} ({self._get_archive_size(self.zip_path)})"
            )
