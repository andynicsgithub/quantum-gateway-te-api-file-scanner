...
### Required Software
- [x] Windows 10/11 or Server 2016+
- [x] Python 3.7 or higher ([download here](https://www.python.org/downloads/))
  - ✅ **Important:** Check "Add Python to PATH" during installation
- [x] Git for Windows ([download here](https://git-scm.com/download/win))
- [x] Network access to Check Point TE appliance (for full testing)

### Optional but Recommended
- [x] Windows PowerShell 5.1+ or PowerShell Core 7+
- [x] Visual Studio Code (for easier editing)
- [x] Administrative access (for testing service features in Phase 3)
...
**Check:**
- [x] Files moved from Input to Benign/Quarantine/Error
- [x] Subdirectory structure preserved
- [x] Response files created in Reports directory
- [x] Empty subdirectories deleted from Input

**Status:** [x] PASS [ ] FAIL [ ] SKIPPED (no appliance)
...
**Status:** [ ] PASS [ ] FAIL [x] SKIPPED (single drive)
...
**Status:** [x] PASS [ ] FAIL [ ] SKIPPED (no file server)
...
**Status:** [x] PASS [ ] FAIL [ ] SKIPPED (no archive)
